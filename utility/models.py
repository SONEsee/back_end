...
class TelecomCustomer(models.Model):
    ...
    Company_name = models.CharField(max_length=500, db_index=True, blank=True, null=True, default='')
    Name = models.CharField(max_length=500, db_index=True, blank=True, null=True, default='')
    Surname = models.CharField(max_length=500, db_index=True, blank=True, null=True, default='')
    National_ID = models.CharField(max_length=100, blank=True, null=True)
    Passport = models.CharField(max_length=100, blank=True, null=True)
    Address = models.TextField(blank=True, null=True, default='')
    Dustrict_ID = models.CharField(max_length=100, db_index=True, blank=True, null=True,default='')
